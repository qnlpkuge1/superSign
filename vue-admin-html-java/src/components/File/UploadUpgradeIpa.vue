<template>
    <div class="upload-container">
        <el-button :style="{background:color,borderColor:color}"
                   ...
                   size="mini"
                   type="primary"
                   @click=" dialogVisible=true">上传IPA文件</el-button>
        <el-dialog
            ...
            <el-tabs v-model="activeName">
                ...
                <div class="upload-content">
                    <span class="text-muted">只能上传{{ ext }}文件，且大小不超过{{ size | renderSize }}</span>
                    <br>
            ...
            <div style="text-align: right;padding-top: 40px;">
                ...
                <el-button size="medium" type="primary" @click="handleSubmit" :loading="uploadLoading">上传</el-button>
            </div>
...
<script>
import { qiuNiuUpToken, updateFile } from "../../api/file/upload";
import { renderSize } from "../../filtres/index";

export default {
    name: "UploadUpgradeIpa",
    props: {
        height: {
            type: Number
        },
                ...
                .then(() => {
                    ...
                    qiuNiuUpToken()
                        .then(response => {
                            ...
                            updateFile(this.appInfoId, formData)
                                .then(response => {
                                    this.uploadLoading = false;
